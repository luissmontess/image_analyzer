...
- `bmp.c` / `bmp.h`: lectura de BMP 8/24/32 bits (segun formato soportado) y escritura en 24 bits
...
Se soportan BMP de 8 y 24 bits sin compresion, y BMP de 32 bits en modos BI_RGB/BI_BITFIELDS/BI_ALPHABITFIELDS. Internamente se normalizan a 24 bits para procesarlos de forma uniforme y la salida se guarda en BMP de 24 bits.
...
- valida que sean BMP de 8/24 bits sin compresion o 32 bits BI_RGB/BI_BITFIELDS/BI_ALPHABITFIELDS
...
- los BMP de 8 bits con paleta tambien son aceptados
- los BMP de 32 bits BI_RGB/BI_BITFIELDS/BI_ALPHABITFIELDS tambien son aceptados
